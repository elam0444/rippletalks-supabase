      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-base text-gray-900">
            Please review and agree to the Ripple Talks terms before
            confirming your fireside chat.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 px-5 py-4 space-y-3 text-sm text-gray-600 leading-relaxed">
            ...
            <p>
              By participating in this Ripple Talks fireside chat, you agree
              to the following:
            </p>
            <ul className="list-disc pl-5 space-y-1.5">
              ...
              <li>
                You consent to Ripple Talks recording and producing a
                highlight video from the fireside chat session.
              </li>
              <li>
                You agree to Ripple Talks posting the highlight video on its
                platforms, championing you and your company as a thought
                leader.
              </li>
              <li>
                You understand that invited CEOs are guests of Ripple Talks
                and attendance is not guaranteed.
              </li>
            </ul>
          </div>
