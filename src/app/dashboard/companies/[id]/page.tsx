...
export default async function CompanyDetailPage({ params }: PageProperties) {
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <AddContactForm companyId={company.id} companyName={company.name} />
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Companies that {company.name} is targeting</CardDescription>
            </div>
                      ...
                      <TableRow key={target.id}>
                        <TableCell>
                          <div className="flex items-center gap-3">
                            ...
                            <span className="font-medium">{targetCompany?.name || 'Unknown'}</span>
                          </div>
                        </TableCell>
                        <TableCell>
